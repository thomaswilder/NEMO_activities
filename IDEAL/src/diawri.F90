...
#  include "vectopt_loop_substitute.h90"
   ...
   !! $Id: diawri.F90 13284 2020-07-09 15:12:23Z smasson $
...
!!						   print *, 'a value of ahmt is', ahmt(jj,ji,jk)
!!						   print *, 'a value of e1e2t is', e1e2t(jj,ji)
!!						   print *, 'a value of Usc is', zztmp
!					   END DO
!		         END DO
!         	END DO
!         ENDIF
